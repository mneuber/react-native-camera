...
public class RCTCamera {
    ...
    public void setOrientation(int orientation) {
        ...
        adjustPreviewLayout(RCTCameraModuleStandalone.RCT_CAMERA_TYPE_FRONT);
        adjustPreviewLayout(RCTCameraModuleStandalone.RCT_CAMERA_TYPE_BACK);
    }
    ...
    public void setCaptureMode(final int cameraType, final int captureMode) {
        ...
        parameters.setRecordingHint(captureMode == RCTCameraModuleStandalone.RCT_CAMERA_CAPTURE_MODE_VIDEO);
        try{
    ...
    public void setCaptureQuality(int cameraType, String captureQuality) {
        ...
        switch (captureQuality) {
            case RCTCameraModuleStandalone.RCT_CAMERA_CAPTURE_QUALITY_LOW:
                pictureSize = getSmallestSize(supportedSizes);
                break;
            case RCTCameraModuleStandalone.RCT_CAMERA_CAPTURE_QUALITY_MEDIUM:
                pictureSize = supportedSizes.get(supportedSizes.size() / 2);
                break;
            case RCTCameraModuleStandalone.RCT_CAMERA_CAPTURE_QUALITY_HIGH:
                pictureSize = getBestSize(parameters.getSupportedPictureSizes(), Integer.MAX_VALUE, Integer.MAX_VALUE);
                break;
            case RCTCameraModuleStandalone.RCT_CAMERA_CAPTURE_QUALITY_PREVIEW:
                ...
                break;
            case RCTCameraModuleStandalone.RCT_CAMERA_CAPTURE_QUALITY_480P:
                pictureSize = getBestSize(supportedSizes, RESOLUTION_480P.width, RESOLUTION_480P.height);
                break;
            case RCTCameraModuleStandalone.RCT_CAMERA_CAPTURE_QUALITY_720P:
                pictureSize = getBestSize(supportedSizes, RESOLUTION_720P.width, RESOLUTION_720P.height);
                break;
            case RCTCameraModuleStandalone.RCT_CAMERA_CAPTURE_QUALITY_1080P:
    ...
    public void setTorchMode(int cameraType, int torchMode) {
        ...
        switch (torchMode) {
            case RCTCameraModuleStandalone.RCT_CAMERA_TORCH_MODE_ON:
                value = Camera.Parameters.FLASH_MODE_TORCH;
                break;
            case RCTCameraModuleStandalone.RCT_CAMERA_TORCH_MODE_OFF:
    ...
    public void setFlashMode(int cameraType, int flashMode) {
        ...
        String value = parameters.getFlashMode();
        switch (flashMode) {
            case RCTCameraModuleStandalone.RCT_CAMERA_FLASH_MODE_AUTO:
                value = Camera.Parameters.FLASH_MODE_AUTO;
                break;
            case RCTCameraModuleStandalone.RCT_CAMERA_FLASH_MODE_ON:
                value = Camera.Parameters.FLASH_MODE_ON;
                break;
            case RCTCameraModuleStandalone.RCT_CAMERA_FLASH_MODE_OFF:
                value = Camera.Parameters.FLASH_MODE_OFF;
                break;
        }
        List<String> flashModes = parameters.getSupportedFlashModes();
    ...
    private RCTCamera(int deviceOrientation) {
        ...
        for (int i = 0; i < Camera.getNumberOfCameras(); i++) {
            ...
            if (info.facing == Camera.CameraInfo.CAMERA_FACING_FRONT && _cameraInfos.get(RCTCameraModuleStandalone.RCT_CAMERA_TYPE_FRONT) == null) {
                _cameraInfos.put(RCTCameraModuleStandalone.RCT_CAMERA_TYPE_FRONT, new CameraInfoWrapper(info));
                _cameraTypeToIndex.put(RCTCameraModuleStandalone.RCT_CAMERA_TYPE_FRONT, i);
                acquireCameraInstance(RCTCameraModuleStandalone.RCT_CAMERA_TYPE_FRONT);
                releaseCameraInstance(RCTCameraModuleStandalone.RCT_CAMERA_TYPE_FRONT);
            } else if (info.facing == Camera.CameraInfo.CAMERA_FACING_BACK && _cameraInfos.get(RCTCameraModuleStandalone.RCT_CAMERA_TYPE_BACK) == null) {
                _cameraInfos.put(RCTCameraModuleStandalone.RCT_CAMERA_TYPE_BACK, new CameraInfoWrapper(info));
                _cameraTypeToIndex.put(RCTCameraModuleStandalone.RCT_CAMERA_TYPE_BACK, i);
                acquireCameraInstance(RCTCameraModuleStandalone.RCT_CAMERA_TYPE_BACK);
                releaseCameraInstance(RCTCameraModuleStandalone.RCT_CAMERA_TYPE_BACK);
            }
        }
    }
