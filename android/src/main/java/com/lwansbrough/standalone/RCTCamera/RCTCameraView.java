...
public class RCTCameraView extends ViewGroup {
    ...
    private int _aspect = RCTCameraModuleStandalone.RCT_CAMERA_ASPECT_FIT;
    private int _captureMode = RCTCameraModuleStandalone.RCT_CAMERA_CAPTURE_MODE_STILL;
    ...
    private void layoutViewFinder(int left, int top, int right, int bottom) {
        ...
        double ratio;
        switch (this._aspect) {
            case RCTCameraModuleStandalone.RCT_CAMERA_ASPECT_FIT:
                ...
                break;
            case RCTCameraModuleStandalone.RCT_CAMERA_ASPECT_FILL:
                ratio = this._viewFinder.getRatio();
                if (ratio * height < width) {
                    viewfinderHeight = (int) (width / ratio);
                    viewfinderWidth = (int) width;
