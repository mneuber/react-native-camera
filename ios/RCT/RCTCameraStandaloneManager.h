...
@interface RCTCameraStandaloneManager : RCTViewManager<AVCaptureMetadataOutputObjectsDelegate, AVCaptureFileOutputRecordingDelegate>
...
@property (nonatomic, strong) RCTCameraStandalone *camera;
